...
# 5e. Prepare SQL Security Script
...
# 5f. Apply Security via Single-User Mode
...
Write-Host "Restarting SQL Server in Normal Mode..."
Stop-Service -Name "MSSQLSERVER" -Force
Start-Sleep -Seconds 2
...
# 5g. Deploy databases.ps1 and Execute it (Download and Restore)
...
# Because SYSTEM is now a sysadmin, this will execute flawlessly.
